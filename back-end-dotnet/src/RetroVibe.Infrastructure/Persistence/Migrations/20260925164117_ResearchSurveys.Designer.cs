...
namespace RetroVibe.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260925164117_ResearchSurveys")]
    partial class ResearchSurveys
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RetroVibe.Domain.Entities.User", b =>
                {
                    ...
                    b.PrimitiveCollection<string>("ManagedSquadIds")
                        .IsRequired()
                        .HasColumnType("TEXT")
                        .HasColumnName("managed_squad_ids");
            ...
            modelBuilder.Entity("RetroVibe.Infrastructure.Persistence.Rows.SurveyResponseRow", b =>
                {
                    ...
                    b.HasIndex("SessionId", "RespondentId")
                        .IsUnique();
